...
public class CommonUtil {
    ...
    public static String getStringFromIoBuffer(IoBuffer buffer, int size, String charset) {
        ...
        try {
            ...
            logger.info("字符解码异常,自动切换第二种解码方式,本次的堆栈信息如下");
            try {
                result = new String(buffer.array(), charset);
            } catch (UnsupportedEncodingException ee) {
                logger.info("字符解码异常,系统不支持该字符集[" + charset + "],本次的堆栈信息如下");
            }
        }
        return result;
    }
    ...
    public static String getString(byte[] data, String charset) {
        ...
        try {
            ...
            logger.info("将byte数组[" + data + "]转为String时发生异常:系统不支持该字符集[" + charset + "]");
            return new String(data);
        }
    }
    ...
    public static byte[] getBytes(String data, String charset) {
        ...
        try {
            ...
            logger.info("将字符串[" + data + "]转为byte[]时发生异常:系统不支持该字符集[" + charset + "]");
            return data.getBytes();
        }
    }
    ...
    public static String getHexSign(String data, String charset, String algorithm, boolean toLowerCase) {
        ...
        try {
            ...
            logger.info("签名字符串[" + data + "]时发生异常:System doesn't support this algorithm[" + algorithm + "]");
            return "";
        }
    ...
    public static String encode(String chinese, String charset) {
        ...
        try {
            ...
            logger.info("编码字符串[" + chinese + "]时发生异常:系统不支持该字符集[" + charset + "]");
            return chinese;
        }
    }
    ...
    public static String decode(String chinese, String charset) {
        ...
        try {
            ...
            logger.info("解码字符串[" + chinese + "]时发生异常:系统不支持该字符集[" + charset + "]");
            return chinese;
        }
    }
     ...
     * @return String
     */
    public static String generateSalt(Byte length)
    {
        if (length <= 0){
            length = 10;
        }
