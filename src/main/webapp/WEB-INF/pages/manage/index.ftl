<@layout.extends name="manage/layout/base.ftl">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div>
                                        <div class="feed-activity-list">
                                            ...
                                            <div class="feed-element">
                                                <a href="profile.html" class="pull-left">
                                                    <img alt="image" class="img-circle" src="${request.contextPath}/assets/manage/img/a2.jpg">
                                                </a>
                                                <div class="media-body ">
                                            ...
                                            <div class="feed-element">
                                                <a href="profile.html" class="pull-left">
                                                    <img alt="image" class="img-circle" src="${request.contextPath}/assets/manage/img/a3.jpg">
                                                </a>
                                                <div class="media-body ">
                                                    <small class="pull-right">2h ago</small>
                                            ...
                                            <div class="feed-element">
                                                <a href="profile.html" class="pull-left">
                                                    <img alt="image" class="img-circle" src="${request.contextPath}/assets/manage/img/a5.jpg">
                                                </a>
                                                <div class="media-body ">
                                                    <small class="pull-right">2h ago</small>
                ...
                <div id="tab-1" class="tab-pane active">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${request.contextPath}/assets/manage/img/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${request.contextPath}/assets/manage/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${request.contextPath}/assets/manage/img/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${request.contextPath}/assets/manage/img/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${request.contextPath}/assets/manage/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${request.contextPath}/assets/manage/img/a7.jpg">
                                </div>
                                <div class="media-body">
    ...
    <!-- Flot -->
    <script src="${request.contextPath}/assets/manage/js/plugins/flot/jquery.flot.js"></script>
    <script src="${request.contextPath}/assets/manage/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${request.contextPath}/assets/manage/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${request.contextPath}/assets/manage/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${request.contextPath}/assets/manage/js/plugins/flot/jquery.flot.pie.js"></script>

    <!-- Peity -->
    <script src="${request.contextPath}/assets/manage/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="${request.contextPath}/assets/manage/js/demo/peity-demo.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="${request.contextPath}/assets/manage/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="${request.contextPath}/assets/manage/js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
    <script src="${request.contextPath}/assets/manage/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="${request.contextPath}/assets/manage/js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="${request.contextPath}/assets/manage/js/plugins/chartJs/Chart.min.js"></script>

    <!-- Toastr -->
    <script src="${request.contextPath}/assets/manage/js/plugins/toastr/toastr.min.js"></script>
